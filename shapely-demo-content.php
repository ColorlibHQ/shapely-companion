<div id="demo_content" class="feature-section">
	<div class="import-full-content">
		...
		<p>
			<a href="#" class="button button-primary" data-action="import-all"><?php _e( 'I want my site to look like your demo', 'shapely-companion' ) ?></a>
	...
	<div class="">
		...
		<p>
			<a href="#" class="button button-secondary" data-action="import-widgets"><?php _e( 'Import Widgets', 'shapely-companion' ) ?></a>
			<span class="spinner"></span>
		</p>
		<div class="updated-message"><p><?php _e( 'Content Imported', 'shapely-companion' ) ?></p></div>
