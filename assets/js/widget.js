jQuery( document ).ready( function() {// jscs:ignore validateLineBreaks
	...
	jQuery( document ).on( 'widget-added widget-updated', function( e, widget ) {
		...
		var context = jQuery( widget ).find( '.shapely-editor-container' );
		jQuery( context ).each( function() {
			shapelyCompanion.textEditor.init( jQuery( this ) );
		} );
	} );
	...
	jQuery( '.shapely-editor-container' ).each( function() {
		shapelyCompanion.textEditor.init( jQuery( this ) );
	} );
