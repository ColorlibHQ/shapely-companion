...
function shapely_companion_add_post_meta_boxes() {
  ...
  add_meta_box(
    ...
    esc_html__( 'Portfolion link', 'example' ),    // Title
...
function shapely_companion_portfolio_link( $post ) { ?>
  ...
  <p>
    <label for="shapely-companion-portfolio-link"><?php _e( "This URL will replace the permalink in Portfolio widget.", 'example' ); ?></label>
    <br />
